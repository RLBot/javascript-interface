...
import { LoadoutPaint, LoadoutPaintT } from '../../flat/flat/loadout-paint.js';
 ...
 */
export class PlayerLoadout implements flatbuffers.IUnpackableObject<PlayerLoadoutT> {
...
static addPrimaryColorLookup(builder:flatbuffers.Builder, primaryColorLookupOffset:flatbuffers.Offset) {
  builder.addFieldStruct(14, primaryColorLookupOffset, 0);
}

static addSecondaryColorLookup(builder:flatbuffers.Builder, secondaryColorLookupOffset:flatbuffers.Offset) {
  builder.addFieldStruct(15, secondaryColorLookupOffset, 0);
}
...
export class PlayerLoadoutT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  PlayerLoadout.addPrimaryColorLookup(builder, (this.primaryColorLookup !== null ? this.primaryColorLookup!.pack(builder) : 0));
  PlayerLoadout.addSecondaryColorLookup(builder, (this.secondaryColorLookup !== null ? this.secondaryColorLookup!.pack(builder) : 0));
