...
import { BoostPad, BoostPadT } from '../../flat/flat/boost-pad.js';
import { GoalInfo, GoalInfoT } from '../../flat/flat/goal-info.js';
 ...
 */
export class FieldInfo implements flatbuffers.IUnpackableObject<FieldInfoT> {
...
static endFieldInfo(builder:flatbuffers.Builder):flatbuffers.Offset {
  ...
  builder.requiredField(offset, 4) // boost_pads
  builder.requiredField(offset, 6) // goals
  return offset;
}
...
unpack(): FieldInfoT {
  return new FieldInfoT(
    this.bb!.createObjList<BoostPad, BoostPadT>(this.boostPads.bind(this), this.boostPadsLength()),
    this.bb!.createObjList<GoalInfo, GoalInfoT>(this.goals.bind(this), this.goalsLength())
  );
}


unpackTo(_o: FieldInfoT): void {
  _o.boostPads = this.bb!.createObjList<BoostPad, BoostPadT>(this.boostPads.bind(this), this.boostPadsLength());
  _o.goals = this.bb!.createObjList<GoalInfo, GoalInfoT>(this.goals.bind(this), this.goalsLength());
}
}

export class FieldInfoT implements flatbuffers.IGeneratedObject {
constructor(
