...
import { RenderMessage, RenderMessageT } from '../../flat/flat/render-message.js';
 ...
 */
export class RenderGroup implements flatbuffers.IUnpackableObject<RenderGroupT> {
...
static endRenderGroup(builder:flatbuffers.Builder):flatbuffers.Offset {
  ...
  builder.requiredField(offset, 4) // render_messages
  return offset;
}
...
unpack(): RenderGroupT {
  return new RenderGroupT(
    this.bb!.createObjList<RenderMessage, RenderMessageT>(this.renderMessages.bind(this), this.renderMessagesLength()),
    this.id()
  );
}
...
unpackTo(_o: RenderGroupT): void {
  _o.renderMessages = this.bb!.createObjList<RenderMessage, RenderMessageT>(this.renderMessages.bind(this), this.renderMessagesLength());
  _o.id = this.id();
}
}

export class RenderGroupT implements flatbuffers.IGeneratedObject {
constructor(
