 ...
 */
export class GoalInfo implements flatbuffers.IUnpackableObject<GoalInfoT> {
...
static endGoalInfo(builder:flatbuffers.Builder):flatbuffers.Offset {
  ...
  builder.requiredField(offset, 8) // direction
  return offset;
}
...
export class GoalInfoT implements flatbuffers.IGeneratedObject {
constructor(
