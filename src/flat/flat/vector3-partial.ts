 ...
 */
export class Vector3Partial implements flatbuffers.IUnpackableObject<Vector3PartialT> {
...
export class Vector3PartialT implements flatbuffers.IGeneratedObject {
constructor(
